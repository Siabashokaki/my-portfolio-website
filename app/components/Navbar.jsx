...
const Navbar = () => {
  ...
  return (
    <>
    <div className='fixed top-0 right-0 w-11/12 -z-10 translete-y-[-80%]'>
        <Image src={assets.header_bg_color} alt='' className='w-full '/>
    </div>
      <nav className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex
        items-center justify-between z-50 ${isScroll ? "bg-white/20 backdrop-blur-lg shadow-sm" : ""}`}>
        {/* -- ---- Logo ---- -- */}
        <a href="#top">
        ...
        <div className='flex items-center gap-4'>
            ...
            <Image src={assets.arrow_icon} alt="Contact" className='w-3' /> </a>

            {/* -- ---- Open Menu Button ---- -- */}
            {/*'block md:hidden ml:3' this line of code used so that the it will display in mobile size screen*/}
            <button className='block md:hidden cursor-pointer ml-3' onClick={openMenu}>
