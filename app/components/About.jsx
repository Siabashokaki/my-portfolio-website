        ...
        <div className='flex w-full flex-col lg:flex-row items-center gap-20 my-20'>
            ...
            <div className='flex-1'>
              <p className='mb-10 max-w-2xl font-Ovo'>
                I am an enthusiastic Frontend Developer and app developer passionate about
                building engaging and efficient web applications. I am eager to learn and grow,
                and I look forward to collaborating on exciting projects that make a positive impact.
              </p>

              <ul className='grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-2xl'>
                {infoList.map(({icon, iconDark, title, description}, index)=>(
                  <li className='border-[0.5px] border-gray-400 rounded-xl p-6 cursor-pointer hover:bg-lightHover
                  hover:-translate-y-1 duration-500 hover:shadow-black hover:shadow-lg' key={index}>
